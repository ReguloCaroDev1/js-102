      ...
      <div className="bg-white rounded shadow p-6 m-4 w-full lg:max-w-4xl">
        ...
        <div>
          <div className="flex mb-4 items-center">
            ...
            <span>
              Add another component to Tailwind ComponentsAdd another component
              to Tailwind Components Add another component to Tailwind
              Components Add another component to Tailwind Components Add
              another component to Tailwind Components Add another component to
              Tailwind Components Add another component to Tailwind Components
              Add another component to Tailwind Components Add another component
              to Tailwind Components Add another component to Tailwind
              Components Add another component to Tailwind Components Add
              another component to Tailwind Components Add another component to
              Tailwind Components
