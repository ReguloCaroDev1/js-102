        ...
        <>
          <div className="h-100 w-full flex items-center justify-center bg-teal-lightest font-sans">
            <div className="bg-white rounded shadow p-6 m-4 w-full lg:max-w-4xl">
              ...
              <div>
                <div key={key} className="flex mb-4 items-center"></div>
                <p className="w-full text-green">Status</p>
                {datos.map((a: any, key) => (
                  <div key={key} className="flex mb-4 items-center">
                    <p className="w-full text-green">{a.name}</p>
                    <p className="w-full  text-green">{a.description}</p>
                    <p>{a.status}</p>
                  </div>
                ))}
              </div>
